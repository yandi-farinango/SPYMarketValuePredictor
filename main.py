...
for i in stocks:
    ...
    df['Macd'], df['Macd Signal'], df['Macd Hist'] = ta.MACD(df['Close Shifted'], fastperiod=12, slowperiod=26,
                                                             signalperiod=9)
...
X = np.array(frames[0].drop(
    columns=["Signal", "Returns", "Open", "High", "Low", "Close", "Adj Close", "High Shifted", "Low Shifted",
             "Close Shifted", "Volume"], axis=1))
